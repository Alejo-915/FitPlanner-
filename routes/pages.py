...
@router.get("/admin/objetivos")
def admin_objetivos(request: Request):
    return templates.TemplateResponse("admin/objetivos.html", {"request": request})


@router.get("/user/config")
def user_config(request: Request):
    return templates.TemplateResponse("user/user_config.html", {"request": request})